...
export const roomScenes: RoomScene[] = [
  ...
  // === COMERCIAL ===
  { id: 'escritorio-nogueira', roomName: 'Escritório Executivo', roomType: 'escritorio', roomCategory: 'comercial', productId: 'nogueira-escuro', productName: 'Nogueira Escuro', productCode: 'KT 1073', image: `${STORAGE_BASE}/escritorio-nogueira.png`, fallbackImage: '/images/quarto-nogueira-escuro.png' },
  { id: 'recepcao-nero', roomName: 'Recepção Corporativa', roomType: 'recepcao', roomCategory: 'comercial', productId: 'nero-marquina', productName: 'Nero Marquina', productCode: 'X89-248', image: `${STORAGE_BASE}/recepcao-nero.png`, fallbackImage: '/images/sala-nero-marquina.png' },
  { id: 'clinica-tiffany', roomName: 'Clínica / Consultório', roomType: 'recepcao', roomCategory: 'comercial', productId: 'tiffany', productName: 'Tiffany', productCode: '512601', image: `${STORAGE_BASE}/clinica-tiffany.png`, fallbackImage: '/images/sala-tiffany.png' },
  { id: 'copa-carvalho', roomName: 'Copa / Área de Café', roomType: 'copa', roomCategory: 'comercial', productId: 'carvalho-natural', productName: 'Carvalho Natural', productCode: 'LTM 88696', image: `${STORAGE_BASE}/copa-carvalho.png`, fallbackImage: '/images/jantar-carvalho.png' },
  { id: 'reunioes-preto', roomName: 'Sala de Reuniões', roomType: 'reunioes', roomCategory: 'comercial', productId: 'preto-liso', productName: 'Preto Liso', productCode: 'LTM 8032', image: `${STORAGE_BASE}/reunioes-preto.png`, fallbackImage: '/images/jantar-preto-liso.png' },
  { id: 'lounge-teca', roomName: 'Lounge / Descanso', roomType: 'lounge', roomCategory: 'comercial', productId: 'bamboo-teca-mel', productName: 'Bamboo Teca Mel', productCode: 'LTM88634', image: `${STORAGE_BASE}/lounge-teca.png`, fallbackImage: '/images/sala-teca-mel.png' },
  { id: 'loja-preto-fosco', roomName: 'Loja / Vitrine', roomType: 'loja', roomCategory: 'comercial', productId: 'preto-fosco', productName: 'Preto Fosco', productCode: 'LT00987', image: `${STORAGE_BASE}/loja-preto-fosco.png`, fallbackImage: '/images/sala-preto-fosco.png' },
  { id: 'restaurante-cerejeira', roomName: 'Restaurante', roomType: 'restaurante', roomCategory: 'comercial', productId: 'cerejeira', productName: 'Cerejeira', productCode: 'LTJCW2016', image: `${STORAGE_BASE}/restaurante-cerejeira.png`, fallbackImage: '/images/quarto-cerejeira.png' },
  { id: 'hotel-lobby', roomName: 'Hotel Lobby', roomType: 'hotel', roomCategory: 'comercial', productId: 'imbuia', productName: 'Imbuia', productCode: 'LTM88626', image: `${STORAGE_BASE}/hotel-lobby.png`, fallbackImage: '/images/jantar-imbuia.png' },
  { id: 'hotel-quarto', roomName: 'Hotel Quarto', roomType: 'hotel', roomCategory: 'comercial', productId: 'carvalho-claro', productName: 'Carvalho Claro', productCode: 'KT 1071', image: `${STORAGE_BASE}/hotel-quarto.png`, fallbackImage: '/images/quarto-carvalho-claro.png' },
  { id: 'barbearia-preto', roomName: 'Barbearia / Salão', roomType: 'barbearia', roomCategory: 'comercial', productId: 'preto-fosco', productName: 'Preto Fosco', productCode: 'LT00987', image: `${STORAGE_BASE}/barbearia-preto.png`, fallbackImage: '/images/sala-preto-fosco.png' },
  { id: 'fachada-cherry', roomName: 'Fachada Comercial', roomType: 'fachada', roomCategory: 'comercial', productId: 'wpc-cherry-wood', productName: 'WPC Cherry Wood', productCode: 'WPC-CW', image: `${STORAGE_BASE}/fachada-cherry.png`, fallbackImage: '/images/externa-cherry.png' },
  { id: 'fachada-teak', roomName: 'Fachada Comercial', roomType: 'fachada', roomCategory: 'comercial', productId: 'wpc-teak', productName: 'WPC Teak', productCode: 'WPC-TK', image: `${STORAGE_BASE}/fachada-teak.png`, fallbackImage: '/images/externa-teak.png' },
];
