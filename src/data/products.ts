...
export const products: Product[] = [
  ...
  // === FORRO PVC ===
  { id: 'forro-pvc-classic', name: 'Forro PVC Classic', code: 'LTM88676-forro', color: '#C4A06A', category: 'forro-pvc', dimensions: '300 x 2800 x 8mm', description: 'Forro PVC de alta qualidade com acabamento amadeirado. Praticidade e design.', application: 'Teto / Forro' },
